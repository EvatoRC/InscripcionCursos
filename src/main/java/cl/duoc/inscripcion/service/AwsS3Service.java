package cl.duoc.inscripcion.service;
...
import cl.duoc.inscripcion.dto.S3ObjectDto;
import cl.duoc.inscripcion.exception.InvalidFileException;
import cl.duoc.inscripcion.exception.S3AccessDeniedException;
import cl.duoc.inscripcion.exception.S3BucketNotFoundException;
import cl.duoc.inscripcion.exception.S3ObjectNotFoundException;
import cl.duoc.inscripcion.exception.S3OperationException;
import cl.duoc.inscripcion.exception.S3UploadException;
...
public class AwsS3Service {
	 ...
	 * @throws InvalidFileException      si el archivo es invalido
	 * @throws S3BucketNotFoundException si el bucket no existe
